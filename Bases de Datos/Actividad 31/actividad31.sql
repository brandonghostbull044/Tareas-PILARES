...
INSERT INTO t_ventas (id_venta, id_cliente, id_vendedor, fecha) VALUES
  (1, 58391, 67840, '2015-02-06'), (2, 58397, 67845, '2015-02-06'),
  (3, 58393, 67846, '2015-02-06'), (4, 58390, 67843, '2015-02-06'),
  (5, 58392, 67849, '2015-02-06'), (6, 58395, 67842, '2015-02-06'),
  (7, 58399, 67848, '2015-02-06'), (8, 58394, 67844, '2015-02-06'),
  (9, 58398, 67847, '2015-02-06'), (10, 58396, 67841, '2015-02-06'),
  (11, 58391, 67840, '2015-03-06'), (12, 58397, 67845, '2015-03-06'),
  (13, 58393, 67846, '2015-03-06'), (14, 58390, 67843, '2015-03-06'),
  (15, 58392, 67849, '2015-03-06'), (16, 58395, 67842, '2015-03-06'),
  (17, 58399, 67848, '2015-03-06'), (18, 58394, 67844, '2015-03-06'),
  (19, 58398, 67847, '2015-03-06'), (20, 58396, 67841, '2015-03-06'),
  (21, 58391, 67840, '2015-04-06'), (22, 58397, 67845, '2015-04-06'),
  (23, 58393, 67846, '2015-04-06'), (24, 58390, 67843, '2015-04-06'),
  (25, 58392, 67849, '2015-04-06'), (26, 58395, 67842, '2015-04-06'),
  (27, 58399, 67848, '2015-04-06'), (28, 58394, 67844, '2015-04-06'),
  (29, 58398, 67847, '2015-04-06'), (30, 58396, 67841, '2015-04-06'),
  (31, 58391, 67840, '2015-05-06'), (32, 58397, 67845, '2015-05-06'),
  (33, 58393, 67846, '2015-05-06'), (34, 58390, 67843, '2015-05-06'),
  (35, 58392, 67849, '2015-05-06'), (36, 58395, 67842, '2015-05-06'),
  (37, 58399, 67848, '2015-05-06'), (38, 58394, 67844, '2015-05-06'),
  (39, 58398, 67847, '2015-05-06'), (40, 58396, 67841, '2015-05-06'),
  (41, 58391, 67840, '2015-07-06'), (42, 58397, 67845, '2015-07-06'),
  (43, 58393, 67846, '2015-07-06'), (44, 58390, 67843, '2015-07-06'),
  (45, 58392, 67849, '2015-07-06'), (46, 58395, 67842, '2015-07-06'),
  (47, 58399, 67848, '2015-07-06'), (48, 58394, 67844, '2015-07-06'),
  (49, 58398, 67847, '2015-07-06'), (50, 58396, 67841, '2015-07-06');
    
INSERT INTO registro_venta (id_venta, id_producto) VALUES
  (1, 12342), (2, 12344), (3, 12340), (4, 12345),
  (5, 12343), (6, 12347), (7, 12346), (8, 12341),
  (9, 12348), (10, 12349), (11, 12344), (12, 12340),
  (13, 12345), (14, 12343), (15, 12347), (16, 12346),
  (17, 12341), (18, 12348), (19, 12349), (20, 12342),
  (21, 12340), (22, 12345), (23, 12343), (24, 12347),
  (25, 12346), (26, 12341), (27, 12348), (28, 12349),
  (29, 12342), (30, 12344), (31, 12345), (32, 12343),
  (33, 12347), (34, 12346), (35, 12341), (36, 12348),
  (37, 12349), (38, 12342), (39, 12344), (40, 12340),
  (41, 12345), (42, 12343), (43, 12347), (44, 12341),
  (45, 12348), (46, 12349), (47, 12342), (48, 12344),
  (49, 12340), (50, 12345);
  
 SELECT t_proveedores.id_proveedor, count(t_productos.id_producto) FROM t_proveedores LEFT JOIN t_productos ON t_proveedores.id_proveedor=t_productos.id_proveedor GROUP BY t_proveedores.id_proveedor;
 SELECT t_proveedores.nombre, t_proveedores.apellido, t_productos.marca FROM t_proveedores INNER JOIN t_productos ON t_proveedores.id_proveedor = t_productos.id_proveedor WHERE t_productos.marca = 'Moshi';
 SELECT t_proveedores.nombre, count(t_productos.id_producto), MAX(t_productos.precio), AVG(t_productos.precio) FROM t_productos INNER JOIN t_proveedores ON t_proveedores.id_proveedor = t_productos.id_proveedor GROUP BY t_proveedores.nombre HAVING AVG(t_productos.precio) < 5000 ORDER BY AVG(t_productos.precio) DESC;
 SELECT t_vendedor.nombre, count(t_ventas.id_venta) AS num FROM t_vendedor LEFT JOIN t_ventas ON t_vendedor.id_vendedor = t_ventas.id_vendedor GROUP BY t_vendedor.nombre HAVING num < 1;
 SELECT t_proveedores.nombre, t_productos.marca, t_productos.modelo, t_productos.precio FROM t_proveedores INNER JOIN t_productos ON t_proveedores.id_proveedor = t_productos.id_proveedor WHERE t_proveedores.nombre = 'Manuel' AND t_proveedores.apellido = 'Hernández';